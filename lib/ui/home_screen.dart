                ...
                children: [
                  Center(
                    child: Container(
                      ...
                      padding: EdgeInsets.symmetric(horizontal: 16.0, vertical: 4.0), child: Text("May 7", style: TextStyle(color: Colors.black)),),
                  ),
                  const SizedBox(height: 16),
                  AppWidgets().receivedMessage(
                    context: context,
                    time: '3:00PM',
                    message: 'Who was that photographer you shared with me recently?',
                  ),
                  const SizedBox(height: 8),
                  AppWidgets().sendMessage('Slim Aarons', '3:01PM'),
