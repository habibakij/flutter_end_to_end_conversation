...
import 'package:test_ui/ui/profile_screen.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  final List<ContactListItemModel> contactList = [
    ...
    ContactListItemModel(
      ...
      name: 'Arif Jamil',
      lastMessage: 'See you at 7 PM!',
      date: 'June 19',
    ),
    ContactListItemModel(
      avatar: 'https://randomuser.me/api/portraits/women/21.jpg',
      name: 'Nusrat Jahan',
      lastMessage: 'What’s your location?',
      date: 'June 18',
    ),
    ContactListItemModel(
      avatar: 'https://randomuser.me/api/portraits/men/19.jpg',
      name: 'Fahim Chowdhury',
      lastMessage: 'Join the Zoom call.',
      date: 'June 18',
    ),
    ContactListItemModel(
    ...
    ContactListItemModel(
      ...
      name: 'Meherun Nesa',
      lastMessage: 'Received the parcel.',
      date: 'June 15',
    ),
    ContactListItemModel(
      avatar: 'https://randomuser.me/api/portraits/men/60.jpg',
      name: 'Shakib Noman',
      lastMessage: 'Going offline now.',
      date: 'June 15',
    ),
    ContactListItemModel(
    ...
    ContactListItemModel(
      ...
      name: 'Nayeem Arafat',
      lastMessage: 'Heading to office now.',
      date: 'June 10',
    ),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF0D0F1A),
        title: Text('ConnectPlus', style: TextStyle(fontSize: 24.0, color: Colors.white)),
        actions: [
          Padding(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => EndToEndChatScreen()),
                      );
                    },
                    child: Padding(
                      padding: const EdgeInsets.only(bottom: 16.0),
                      child: HomeScreenWidget().contactListItemWidget(
                        contactList[index].avatar,
                        contactList[index].name,
                        contactList[index].lastMessage,
